...
Example:
0100,0011,1010,1001
Then the output should be: (Original proposed answer 1010)
0100,1010 (The actual answer should be this, as 0100 is divisible by 5)
...
print(','.join(value)) #this only outputs 1010 as it was stated originally in the problem
```
```python
try: # acidsafari commited answer, sorry for my novice level of coding
